...
const AboutPage = ({ onBack, startGame, status, isProcessing }) => {
    return (
                ...
                <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4">
                    ...
                    <div className="flex flex-col items-end gap-1">
                        <button
                            ...
                            className={`bg-primary text-secondary px-6 py-2 font-bold uppercase tracking-wider text-sm border-2 border-secondary pixel-shadow transition-all duration-200 ${isProcessing ? 'opacity-50 cursor-not-allowed' : 'pixel-shadow-hover'}`}
                        >
